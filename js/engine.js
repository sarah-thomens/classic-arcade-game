...
var Engine = ( function( global )
               {
                 ...
                 * main Function
                 *
                 * This function serves as the kickoff point for the game loop itself and handles properly
                 ...
                 * init Function
                 *
                 * This function does some initial setup that should only occur once, particularly setting
                 ...
                 * update Function
                 *
                 * This function is called by main (our game loop) and itself calls all of the functions
                 * which may need to update entity's data. Based on how you implement your collision
                 * detection (when two entities occupy the same space, for instance when your character
                 * should die), you may find the need to add an additional function call here. For now, we've
                 * left it commented out - you may or may not want to implement this functionality this way
                 * (you could just implement collision detection on the entities themselves within your
                 * app.js file).
                 ===========================================================================================*/
                function update( dt )
                {
                 ...
                 *
                 * This is called by the update function and loops through all of the objects within your
                 * allEnemies array as defined in app.js and calls their update() methods. It will then call
                 * the update function for your player object. These update methods should focus purely on
                 * updating the data/properties related to the object. Do your drawing in your render methods.
                 ===========================================================================================*/
                 ...
                 * render Function
                 *
                 * This function initially draws the "game level", it will then call the renderEntities
                 * function. Remember, this function is called every game tick (or loop of the game engine)
                 * because that's how games work - they are flipbooks creating the illusion of animation but
                ...
                function render( )
                {
                  ...
                  //==Loop through rows and columns and, using rowImages array, draw correct image for that portion of "grid"===========================================================================
                 ...
                 *
                 * This function is called by the render function and is called on each game tick. Its
                 * purpose is to then call the render functions you have defined on your enemy and player
                 ...
                 * reset Function
                 *
                 * This function does nothing but it could have been a good place to handle game reset states
                 * - maybe a new game menu or a game over screen those sorts of things. It's only called once
                 * by the init() method.
                 ===========================================================================================*/
                 function reset( )
                 {
